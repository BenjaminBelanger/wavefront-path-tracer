...
namespace lumina
{
    ...
    struct LightSample
    {
        ...
        __host__ __device__ LightSample()
            : light_idx(-1), point_on_light(make_float3(0.0f)), light_normal(make_float3(0.0f, 1.0f, 0.0f)), emission(make_float3(0.0f)), pdf(0.0f)
        {
        }
    ...
    struct PathSample
    {
        ...
        __host__ __device__ PathSample()
            : reconnection_pos(make_float3(0.0f)), reconnection_normal(make_float3(0.0f, 1.0f, 0.0f)), Lo(make_float3(0.0f)), path_length(0), is_valid(false)
        {
        }
    };
